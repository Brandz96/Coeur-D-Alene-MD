...
class RootSecondScreen extends StatefulWidget {
  ...
  RootSecondScreen({Key key, this.title, this.root, this.fnotes, this.text,
    this.backGroundColor, this.tileBackGroundColor}) : super(key: key);


  @override
  _RootSecondScreenState createState() => _RootSecondScreenState(root, backGroundColor, tileBackGroundColor);
}
class _RootSecondScreenState extends State<RootSecondScreen> {
  ...
  _RootSecondScreenState (this.root, this.backGroundColor,this.tileBackGroundColor);
